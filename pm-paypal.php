		...
		*/
		if(get_option('pm_paypal_use_sandbox'))
		{
			...
			$this->paypal_config = array(
				'mode' => 'sandbox',
				'api_username' => get_option('pm_sandbox_api_username'),
				'api_password' => get_option('pm_sandbox_api_password'),
				'api_signature' => get_option('pm_sandbox_api_signature'),
				'api_app_id' => get_option('pm_sandbox_api_app_id')
			);
		...
		else
		{
			...
			$this->paypal_config = array(
				'mode' => 'live',
				'api_username' => get_option('pm_api_username'),
				'api_password' => get_option('pm_api_password'),
				'api_signature' => get_option('pm_api_signature'),
				'api_app_id' => get_option('pm_api_app_id')
			);
